...
- **Frontier query**: list the map's open sub-issues, drop any with an open blocker (`issue_dependencies_summary.blocked_by > 0`) or an assignee; first in map order wins.
